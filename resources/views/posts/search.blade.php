				...
				<div style="background-color: #ffffffa6;">
					...
					<div style="background-color: #ffffffa6;">
						...
						@foreach( $posts as $post )
							<div class="row">
								<div class="d-flex m-2">
									<div class="col-sm-2">
										<p><a href="{{$post->user->profile->slug}}/{{$post->slug}}"><img class="w-100 p-1"
													src="{{$post->image()}}"></a></p>
									</div>
									<div class="col-sm-10 p-1">
										<p class="mt-1" style="padding-right: 15px;"><strong><a
						...
						<div class="col d-flex justify-content-center mb-5 mt-3 pb-3">
							<div class="row list10">{{ $posts->withQueryString()->links( 'pagination::bootstrap-4' ) }}
							</div>
						</div>
