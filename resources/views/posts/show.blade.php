    ...
    <div class="row justify-content-center">
        <div class="col-md-8" >
            <div style="background-color: #ffffffa6;">
                <div class="p-2" class="card-header"><h5 class="mt-2">{{$post->title}}</h5></div>
                ...
                <div style="background-color: #ffffffa6;">
                        ...
                        <div class="row">
                            <div class="d-flex m-2">
                                <p class="mt-1 text-justify" style="padding: 10px 30px 10px 20px;">
                                    <img style="float: left; margin-right:20px;" width="350px" height="350px" src="{{$post->image()}}">
                                    <span>{{$post->content}}</p></span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="text-center">
                        ...
                        <strong>Posts: </strong>{{$post->user->posts->count()}}</p>
